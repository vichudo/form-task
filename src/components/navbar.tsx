...
export const Navbar: FC = () => {
    ...
    // Create a new array with the Admin tab if the user is an admin
    const navigationItems = session?.user?.subscriptionPlan === 'admin'
        ? [...navigation, ...[{ name: 'Admin', href: '/admin' }, { name: 'Mensajes', href: '/admin/mensajes' }]]
        : navigation
